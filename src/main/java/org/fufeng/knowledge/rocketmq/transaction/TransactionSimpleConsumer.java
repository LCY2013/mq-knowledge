...
import org.fufeng.knowledge.rocketmq.common.Common;
...
public class TransactionSimpleConsumer {

    private static final Logger logger = LoggerFactory.getLogger(TransactionPushConsumer.class);
    ...
    public static void main(String[] args) {
        ...
        ClientConfiguration clientConfiguration = ClientConfiguration.newBuilder()
                .setEndpoints(Common.endpoint)
                .build();
        // 订阅消息的过滤规则，表示订阅所有Tag的消息。
        String tag = "*";
        FilterExpression filterExpression = new FilterExpression(tag, FilterExpressionType.TAG);
        // 为消费者指定所属的消费者分组，Group需要提前创建。
        String consumerGroup = "TransactionTopic";
